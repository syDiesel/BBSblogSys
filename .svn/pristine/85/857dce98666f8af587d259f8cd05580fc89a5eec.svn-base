...
<script type="text/javascript">
	function checkLabelApply() {

		var label = ducument.form1.board.value;
		alert(label);
		if ($.trim(label) != "") {
			if ($.trim(label).length > 20) {
			...
			alert("Please enter the apply label");
			return false;
		}
	}
</script>
...
<!---------------------------login_begin  ------------------------->
	...
	Tag Application</span>
	<div id="forms" class="mt10"  style="width:70%;height:50%;margin:50px auto;">
        <div class="box">
          <div class="box_border" style="height:100%;">
            <div class="box_top"></div>
            <div class="box_center" style="width:80%;">
              <form action="saveLabelApply" method="post" name="form1" enctype="multipart/form-data" class="jqtransform">
               <table class="form_table pt15 pb15" width="100%" border="0" cellpadding="0" cellspacing="0">
                 <tr >
                  <td class="td_right" valign="top" style="width:100px;">Union:</td>
                  <td class="" style="width:480px;">
                    ...
                    <span class="fl" >
                      <div class="select_border"> 
                        ...
                        <c:forEach items="${listBoard}" var="listBoard">
										<option value="${listBoard.id}">${listBoard.boardName}</option>
									</c:forEach>
                        </select> 
                        </div> 
                      </div> 
                 ...
                 <tr>
							<td class="td_right" valign="top" >Tag:</td>
							<td><input type="text" name="label" id="label"
								maxlength="20" class="input-text lh30" size="40"/>
								<br>
								<font style="font-size:12px;">Note: apply a tag one time, if submit multiple labels one time, the application will not be approved;</font>
								</td>
						</tr>
                 ...
                 <tr>
                   ...
                   <td class="">
                     <input type="submit" id="button"
                      onclick="return checkLabelApply()" class="btn btn82 btn_save2" value="Submit"> 
