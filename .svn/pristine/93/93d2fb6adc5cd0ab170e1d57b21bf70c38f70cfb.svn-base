        ...
        <div class="box">
          <div class="box_border" style="height:100%;">
            ...
            <div class="box_center">
              <form action="forumJubao.do?postId=${post.id}" method="post" name="form1" enctype="multipart/form-data" class="jqtransform">
               <table class="form_table pt15 pb15" width="100%" border="0" cellpadding="0" cellspacing="0">
                 <tr >
                  <td class="td_right">Post:</td>
                  <td class="">
                  <a href="toTopics?post_id=${post.id}">
            <c:if test="${post.subject.length()>20}">${post.subject.substring(0,19)}...</c:if>
             <c:if test="${post.subject.length()<20}">${post.subject}</c:if>
             </a>
                  </td>
                 </tr>
               
                 <tr>
                  <td class="td_right">Reasons:</td>
                  <td class="">
                    <textarea id="reason" name="reason" cols="30" rows="10" class="textarea"></textarea>
                  </td>
                 </tr>
                 ...
                 <tr>
                   ...
                   <td class="">
                     <input type="submit" id="button" onclick="return check()" class="btn btn82 btn_save2" value="Report"> 
