											...
											<table width="100%" border="0" cellspacing="0"
												...
												<tr>
													...
													<td width="94%" valign="bottom">
														...
														<span class="STYLE1"> 您当前的位置是：${typeName} -> 列出信息</span>
													</td>
												</tr>
											</table>
										</td>
					...
					<table width="100%" border="0" cellpadding="0" cellspacing="1" bgcolor="#a8c7ce">
						...
						<c:if test="${!empty listNotice}">
							...
							<tr>
								...
								<td height="20" bgcolor="#FFFFFF" class="STYLE19">
									<div align="center">
										${listNotice.noticeSubject}
									</div>
								</td>
								<td height="20" bgcolor="#FFFFFF" class="STYLE19">
									<div align="left" style="margin-left:5px ">
										${listNotice.noticeContent}							
									</div>
								</td>
								<td height="20" bgcolor="#FFFFFF" class="STYLE19">
									<div align="center">
										${listNotice.noticeTime}
									</div>
								</td>
								<td height="20" bgcolor="#FFFFFF" class="STYLE19">
									<div align="center">
										<!-- 此处取出用户名字 -->
										${listNotice.userInfo.nickName}
									</div>
								</td>
								<td height="20" bgcolor="#FFFFFF">
									<div class="STYLE21">								
										&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
										<a href="toUpdateNotice.do?id=${listNotice.id}">修改</a>&nbsp;&nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;&nbsp;									
										<a href="deleteNotice.do?id=${listNotice.id}">删除</a>
									</div>
								</td>
							</tr>
						...
						<tr>
						    <td colspan="9" style="text-align:center;margin:0px;padding:4px;font-size: 12px;height: 20px;">
						  	...
						  	<!-- 此处设置分页 -->
						  	<c:choose>
						  		<c:when test="${record>1}"><a href="listNotice.do?record=1" style="text-decoration: none">首页 </a>&nbsp;&nbsp;</c:when>
								<c:otherwise><a>首页</a>&nbsp;&nbsp;</c:otherwise>
						  	</c:choose>
						  	
							<c:choose>
								<c:when test="${record>1}"><a href="listNotice.do.do?record=${record-1}" style="text-decoration: none">上页 </a>&nbsp;&nbsp;</c:when>
							...
							<c:choose>							
								<c:when test="${record<allPage}"><a href="listNotice.do.do?record=${record+1}" style="text-decoration: none">下页  </a>&nbsp;&nbsp;</c:when>
								<c:otherwise><a>下页</a>&nbsp;&nbsp;</c:otherwise>
							</c:choose>
							
							<c:choose>
								<c:when test="${record<allPage}"><a href="listNotice.do.do?record=${allPage}" style="text-decoration: none">末页  </a>&nbsp;&nbsp;</c:when>
