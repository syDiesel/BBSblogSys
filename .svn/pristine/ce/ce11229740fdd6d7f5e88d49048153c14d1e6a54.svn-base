...
<link href="<%=basePath%>css/headfoot.css" rel="stylesheet"
	type="text/css" />
<link href="<%=basePath%>css/Forums1/home.css" rel="stylesheet"
	type="text/css" />
...
<div id="content" style="background:#fff;margin-bottom:30px;margin-top:20px;display:inline-block;">
  <div class="mod-setting clearfix"
   ...
   <div style="height:400px;text-align:center;font-size:20px;margin-top:140px;">
   <c:if test="${resultType!='saveLabelApply'}">
   ${errorResult}<br/>
   </c:if>
   <c:if test="${resultType=='saveLabelApply'}">
   ${errorResult}<br/>
   	<a href="addLabelApply" style="font-size:14px;">Continue To Aad</a>
   </c:if>
    <a href="<%=basePath%>listPostByBoard" style="font-size:14px;">Back To Forum Homepage</a>
