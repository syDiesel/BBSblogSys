		...
		<div class="showQuestion">
			<div class="mn">
				...
				<div class="bm bw0 pgs cl" style="text-align:center">
					<div class="pg" >
					<a href="web/QandA/Home/${bod.getId()}/1">Homepage</a>
						<c:if test="${pageNum>1}">
							<a href="web/QandA/Home/${bod.getId()}/${pageNum-1}">Page up</a>
						</c:if>
						<c:if test="${pageNum==1}">
							<a href="web/QandA/Home/${bod.getId()}/1">Page up</a>
						</c:if>
						...
						<c:if test="${pageNum<pageTotal}">
							<a href="web/QandA/Home/${bod.getId()}/${pageNum+1}">Page down
							</a>
						</c:if>
						<c:if test="${pageNum==pageTotal}">
							<a href="web/QandA/Home/${bod.getId()}/${pageTotal}">Page down
							</a>
						</c:if>
						<a href="web/QandA/Home/${bod.getId()}/${pageTotal}">Last page
							</a>
					</div>
				</div>
				</div>
