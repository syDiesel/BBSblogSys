...
<script type="text/javascript">
    ...
    var d = new Date('<%=request.getAttribute("nowTime")%>');
    
    var time=document.getElementById("time").value;

    if($.trim(time)=="")
    {
      document.getElementById("errorInfo").innerHTML="Please Enter Time";
      return false;
    }
    ...
    if (n >= 0) {
        document.getElementById("errorInfo").innerHTML="Please do not enter an expiration time";
        return false;
    } else {
       return true;
    }
        ...
        <div class="box">
          <div class="box_border" style="height:100%;">
            ...
            <div class="box_center">
              <form action="setNotSay?forumUser_id=${forumUser.id}" method="post" name="form1" enctype="multipart/form-data" class="jqtransform">
               <table class="form_table pt15 pb15" width="100%" border="0" cellpadding="0" cellspacing="0">
                 <tr><td class="td_right">User Name:</td><td>${forumUser.nickName}</td></tr>
                 <tr><td class="td_right">Level:</td><td>${forumUser.userLevel }&nbsp;level</td></tr>
             
               
                 <tr>
							<td class="td_right">Release Time:</td>
							<td><input type="text" class="input-text lh30" id="time"
                 ...
                 <tr>
                   ...
                   <td class="">
                     <input type="submit" id="button"
                      onclick="return check()" class="btn btn82 btn_save2" value="Submit"> 
                     <font style="color:red;font-size:12px;" id="errorInfo"></font>
                   </td>
                 </tr>
               </table>
               </form>
