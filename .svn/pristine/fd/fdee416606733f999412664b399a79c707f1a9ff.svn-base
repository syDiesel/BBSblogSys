...
'#Tools {width:204px;background:#d3e8f7;padding:0px;}'+
'#Tools li{padding-bottom:1px;}'+
'#Tools a{color:#FFF;}'+
'#Tools a:hover{border:1px solid #09fae9;background:#d0e7ef;}'+
'#Title {width:204px;background:#;border-bottom:1px solid #000;}'+
'#Title li{height:16px;padding-top:3px;ccd6da}'+
'#sYear,#sMonth {width:44px;height:16px;border:1px solid #88A9C9;border-right:0;padding-top:2px;}'+
'#SArr {width:19px;height:18px;background:#E2EBF4;font-size:10px;text-align:center;color:#a4b1c3;border:1px solid #88A9C9;border-left:0;margin-right:3px;cursor:pointer;}'+
...
'#Select #SelectBn {background:#c3e0fe;font-size:8px;line-height:7px;height:7px;text-align:center;color:#44b6ae;}'+
'#Select #SelectBn:hover{background:#59b6f0;color:#FFF;}#SArr,#sYear,#sMonth{float:left;}'+
