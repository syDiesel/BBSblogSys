	...
	<div class="col-content">
		...
		<div class="private-new" style="display: block;">
			<div class="row nty-mas-rtop">
				<h3 class="noy-pl15">
					<i class="icon-envelope">&nbsp; </i> 查找用户
				</h3>
			</div>
			<form class="form-horizontal nty-sent-newmas" name="send_new"
				action="<%=basePath%>web/management/Role/findUser" method="post">

				<div class="form-group">
					<label class="pull-left control-label" style="text-align: right;">昵称：</label>
					<div class="pull-right">
						<input type="text" placeholder="请输入用户昵称" name="nickName"
				...
				<div class="form-group2">
					...
					<button class="btn btn-primary send-private nty-ml87">查找用户</button>
				</div>
			</form>
		</div>
