		...
		<div class="content">
			...
			<a href="<%=basePath%>fileupload.do">
				<button style="margin-top:20px;" class="submitButton"
					onclick="javascrtpt:window.location.href='<%=basePath%>fileupload.do'">upload more</button>
			</a> <a href="<%=basePath%>listAlbum.do?id=${userInfo.id}">
				<button style="margin-top:20px;" class="submitButton"
					onclick="javascrtpt:window.location.href='<%=basePath%>listAlbum.do?id=${userInfo.id}'">see album</button>
			</a>
		</div>
	</div>
	<!--mainbox end-->
