        ...
        <div class="box">
          <div class="box_border">
            ...
            <div class="box_center">
              <form action="web/management/Label/new" method="post" enctype="multipart/form-data" class="jqtransform">
               <table class="form_table pt15 pb15" width="100%" border="0" cellpadding="0" cellspacing="0">
                 <tr >
                  <td class="td_right">版块：</td>
                  <td class="">
                 ...
                 <tr>
                  ...
                  <td class=""> 
                    <input type="text" name="labelName" class="input-text lh30" size="40">
                  </td>
                 ...
                 <tr>
                  ...
                  <td class="">
                    <textarea name="labelDesc" id="" cols="30" rows="10" class="textarea"></textarea>
                  </td>
                 </tr>
