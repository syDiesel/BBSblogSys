...
<!---------------------------login_begin  ------------------------->
	...
	<div class="mainbox">
		...
		<div class="content">
			...
			<br />
			<h3>upload well</h3>
			<a href="<%=basePath%>zizhi.do">
				<button style="margin-top:20px;" class="submitButton"
					onclick="javascrtpt:window.location.href='<%=basePath%>zizhi.do'">upload more</button>
			</a> <a href="<%=basePath %>permission.do?page=${page}&blId=${userInfo.id}">
				<button style="margin-top:20px;" class="submitButton"
					onclick="javascrtpt:window.location.href='<%=basePath %>permission.do?page=${page}&blId=${userInfo.id}'">查看相册</button>
			</a>
		</div>
	</div>
	<!--mainbox end-->
