        ...
        <div class="box">
          <div class="box_border" style="height:100%;">
            ...
            <div class="box_center" style="width:80%;">
              <form action="saveMasterApply" method="post" name="form1" enctype="multipart/form-data" class="jqtransform">
               <table class="form_table pt15 pb15" width="100%" border="0" cellpadding="0" cellspacing="0">
                 <tr >
                  <td class="td_right" style="width:100px;" valign="top">Union:</td>
                ...
                <tr>
                  <td class="td_right" valign="top">Reasons:</td>
                  <td class="">
                    <textarea name="applyReason" id="applyReason" cols="30" rows="10" class="textarea"></textarea>
                  </td>
                 </tr>
                 ...
                 <tr>
                   ...
                   <td class="">
                     <input type="submit" id="button"
                       onclick="return checkApplyReason()" class="btn btn82 btn_save2" value="Submit"> 
