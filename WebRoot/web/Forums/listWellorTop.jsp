...
<div class="floor1" style="background:#fff;">
     ...
     <div class="manageForum">
          ...
          <div class="widget">
              ...
              <c:if test="${listForum.size()>0}">
              <c:forEach end="${listForum.size()}" begin="1" var="size" step="1">
                
              <tr>
              <td>${listForum.get(size-1).subject}</td>
              <td>
              ...
              <td><a href="cancelWellorTop?post_id=${listForum.get(size-1).id}&type=${type}" onclick="return confirm1()">Cancle</a></td>
              </tr>   
             ...
             <div class="fenye">
          	    <!-- 此处设置分页 -->
						 ...
						 <a href="listWellorTop_${masterBoardId}?record=${record-1}&type=${type}">Page up</a>
						</c:if>
						...
						<c:forEach begin="1" end="${allPage}" step="1" var="i">
						     ...
						     <a href="listWellorTop_${masterBoardId}?type=${type}&record=${i}"> 
						...
						<c:forEach begin="${record-5}" end="${record+4}" step="1" var="i">
						 ...
						 <a href="listWellorTop_${masterBoardId}?record=${record+1}&type=${type}">Page down</a>
                         </c:if>
