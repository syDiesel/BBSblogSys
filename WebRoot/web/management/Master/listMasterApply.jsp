...
<body>
		...
		<tr>
			<td align="center">
				<table width="95%" border="0" cellpadding="0" cellspacing="1"
					...
					<c:if test="${!empty listMasterApply}">
						<%
							int i = 1;
						%>
						<c:forEach items="${listMasterApply}" var="listMasterApply">
							...
							<tr>
								...
								<td height="20" bgcolor="#FFFFFF" class="STYLE19">
									<div align="center" style="margin-left: 5px">${ listMasterApply.userInfo.userName}
									</div>
								</td>
								<td height="20" bgcolor="#FFFFFF" class="STYLE19">
									<div align="center">${ listMasterApply.board.boardName}</div>
								</td>
								<td height="20" bgcolor="#FFFFFF" class="STYLE19">
									<div align="center">${ listMasterApply.time}</div>
								</td>
								<td height="20" bgcolor="#FFFFFF" class="STYLE19">
									<div align="center">${ listMasterApply.applyDesc}</div>
								</td>

								<td height="20" bgcolor="#FFFFFF">
									<div class="STYLE21" align="center">
										<a href="setApplyOk?apply_id=${listMasterApply.id }">批准</a>&nbsp;|&nbsp;
										<a href="deleteApply?apply_id=${listMasterApply.id }">删除</a>
									</div>
								</td>
							</tr>
	...
	<div align="center" style="margin-top: 80px;">
		<%-- <pg:pager url="web/management/Master/listApply" items="${pm.total}"
		 ...
		 <!-- 此处设置分页 -->
                         <c:if test="${record>1}">
						<a href="listApply?record=${record-1}">上一页</a>
						</c:if>
						
					   	<c:if test="${allPage<=10}"> 
						<c:forEach begin="1" end="${allPage}" step="1" var="i">
						      &nbsp; <a href="listApply?record=${i}"> 
						...
						<a href="listApply?record=${record+1}">下一页</a>
                         </c:if>
	</div>
	</c:if>
</body>
