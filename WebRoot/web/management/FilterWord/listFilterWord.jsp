...
<body>
	...
	<table width="100%" border="0" align="center" cellpadding="0"
		...
		<tr>
			<td align="center">
				<table width="45%" border="0" cellpadding="0" cellspacing="1"
					bgcolor="#a8c7ce" style="float: left; margin: 0 25px;">
					<tr>
						...
						<th width="10%" height="20" bgcolor="d3eaef" class="STYLE6">
							<div align="center">
								<span class="STYLE10">敏感词</span>
							</div>
						</th>
						<th width="10%" height="20" bgcolor="d3eaef" class="STYLE6">
							<div align="center">
								<span class="STYLE10">替代词</span>
							</div>
						</th>
					...
					<c:if test="${!empty pm.datas}">
						...
						<c:forEach items="${pm.datas}" var="item" step="2" begin="0"  varStatus="status">

							
							<tr>
								<td height="20" bgcolor="#FFFFFF" class="STYLE6">
									<div align="center">
										<span class="STYLE19">${ status.index + 1}</span>
									</div>
									<div>
								...
								<td height="20" bgcolor="#FFFFFF" class="STYLE19">
									<div align="center" style="margin-left: 5px">${ item.find}
									</div>
								</td>
								<td height="20" bgcolor="#FFFFFF" class="STYLE19">
									<div align="center">${ item.replacement}</div>
								</td>


								<td height="20" bgcolor="#FFFFFF">
									<div class="STYLE21" align="center">
										<a href="web/management/FilterWord/list_${item.id }">修改</a>&nbsp;&nbsp;&nbsp;&nbsp;|&nbsp;&nbsp;&nbsp;&nbsp;
										<a href="web/management/FilterWord/delete_${item.id }">删除</a>
									</div>
								</td>
							</tr>
				...
				<table width="45%" border="0" cellpadding="0" cellspacing="1"
					...
					<c:if test="${!empty pm.datas}">
						...
						<c:forEach items="${pm.datas}" var="item" step="2" begin="1" varStatus="status">
...
<div align="center" style="margin-top:80px;">   
	<pg:pager url="web/management/FilterWord/list" items="${pm.total}"
		export="currentPageNumber=pageNumber"  maxPageItems="30" maxIndexPages="30">
		<pg:first>
