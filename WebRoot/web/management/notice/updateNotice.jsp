	...
	<div class="col-content">
		...
		<div class="private-new" style="display: block;">
			<div class="row nty-mas-rtop">
				<h3 class="noy-pl15">
					<i class="icon-envelope">&nbsp; </i> 公告
				</h3>
			</div>
			<form class="form-horizontal nty-sent-newmas" name="send_new"
				action="<%=basePath%>updateNotice.do?id=${notice.id}" method="post">
            ...
            <div class="pull-right">
              ...
              <span class="error error-empty help-block">请输入有效的收信人</span>            </div>
				...
				<div class="form-group">
					...
					<div class="pull-right">
						<input type="text" placeholder="请输入信息主题" name="msgTitle" value="${notice.noticeSubject }"
				...
				<div class="form-group1">
					...
					<div class="pull-right">
						<textarea rows="6" class="form-control" name="msg"
							placeholder="可发送200字以内的内容">${notice.noticeContent }</textarea>
					</div>
				</div>
